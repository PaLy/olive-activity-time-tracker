  ...
  new Map([
    ...
    [
      ...
      signal({
        ...
        parentActivityID: signal("code-review"),
        childActivityIDs: signal([]),
      }),
    ],
    [
    ...
    [
      ...
      signal({
        ...
        parentActivityID: signal("helping"),
        childActivityIDs: signal([]),
      }),
    ],
    [
    ...
    [
      ...
      signal({
        ...
        parentActivityID: signal("personal"),
        childActivityIDs: signal([]),
      }),
    ],
    [
